...
void igvInterfaz::set_glutKeyboardFunc(unsigned char key, int x, int y) {
	...
	case 'C': // decrementar la distancia del plano cercano
		...
		//METODOS DE CREAR FIGURAS
	case '1': //Crea una figura de tipo monigote
		interfaz.escena.crearMuebles(0);
		break;
	case '2': //Crea una silla
		interfaz.escena.crearMuebles(1);
		break;
	case '3': //Crea una mesa
		interfaz.escena.crearMuebles(2);
		break;
	case '4': //Crea un cuadro
		interfaz.escena.crearMuebles(3);
		break;
	case '5': //Cuadro doble
		interfaz.escena.crearMuebles(4);
		break;
	case '6': //Planta
		interfaz.escena.crearMuebles(5);
		break;
		//METODOS DE ACTUALIZAR FIGURAS
	case 'b':
		interfaz.escena.borrarMuebles();
		break;
	case 'g':
		interfaz.escena.rotarFigura();
		break;
